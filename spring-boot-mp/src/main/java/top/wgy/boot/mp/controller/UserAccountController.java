package top.wgy.boot.mp.controller;
...
import top.wgy.boot.mp.common.ApiResponse;
...
public class UserAccountController {
     ...
     */
    @GetMapping("/page")
    public ApiResponse<Page<UserAccount>> getUsersPage(@RequestParam(defaultValue = "1") int current, @RequestParam(defaultValue = "10") int size) {
        Page<UserAccount> page = new Page<>(current, size);
        IPage<UserAccount> result = userAccountService.page(page);
        return ApiResponse.success("分页查询成功", (Page<UserAccount>) result);
    }
